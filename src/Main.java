...
public class Main{
    public static void main(String[] args){
        try{
            Client Corbeau = new Client("SARL Corbeau","8","rue de la grange","54345","Villefroid","0787876453","corbeau@aol.fr",300,41);
            Client Fortunado = new Client("Menuiserie Fortunado","1","grande rue","54500","Loisy","0383898745","fortune@aol.fr",400, 20);
